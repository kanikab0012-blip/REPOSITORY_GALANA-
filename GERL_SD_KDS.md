...
company_or_entity: GALANA ENERGIES LIMITED(RWANDA)
source_document: GERL SD KDS.xls
---

# GERL SD KDS - KDS/KSD Guide
...
- This document contains SAP SD KDS values for `GALANA ENERGIES LIMITED(RWANDA)`.
...
| Column 1 | Column 2 | Column 3 | Column 4 |
| --- | --- | --- | --- |
| GALANA ENERGIES LIMITED(RWANDA) |  |  |  |
