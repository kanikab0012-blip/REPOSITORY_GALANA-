...
company_or_entity: GALANA ENERGY LIMITED(UGANDA)
source_document: GEUL SD KDS.xls
---

# GEUL SD KDS - KDS/KSD Guide
...
- This document contains SAP SD KDS values for `GALANA ENERGY LIMITED(UGANDA)`.
